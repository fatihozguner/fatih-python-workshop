...
# and assign route of no path ('/')@app.route('/')

@app.route('/')
def home():
    return 'This is home page for "/" path, <h1>Welcome to hands-on project</h1>'
...
@app.route('/hello')
def hello():
    return '<h1>Hello world from Fatih </h1>'
...
def admin():
    authorized=True
    if authorized:
        return 'You can see this admin page.'
    else:
